...
function assert(label, validate, parent) {
    var params = {
        type: parent ? types.STEP : types.SCENE,
        parentType: parent ? types.SCENE : types.SCENARIO,
        label: label,
        method: function() {},
        validate: validate
    };
    return parent ? createElementStep(params, parent) : create(params);
}
...
runner.inPageMethods.push(function() {
    "use strict";
    var $fn = this.jQuery ? this.jQuery.fn : this.angular.element, input;
...
runner.elementMethods.push(function(target) {
    ...
    target.sendMouse = function(focus, namespace) {
        return runner.createElementStep({
            label: "sendMouse",
            method: function() {
                if (this.element[0].href.length) {
