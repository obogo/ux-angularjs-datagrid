...
- Release 1.2.6 [Source Code (zip)](https://github.com/obogo/ux-angularjs-datagrid/archive/v1.2.7.zip) | [Source Code (tar.gz)](https://github.com/obogo/ux-angularjs-datagrid/archive/v1.2.7.tar.gz)
