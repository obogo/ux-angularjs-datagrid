...
exports.datagrid.coreAddons.templateModel = function templateModel(inst) {
    ...
    inst.templateModel = function() {
        ...
        function createTemplateFromScriptTemplate(scriptTemplate) {
            var name = getScriptTemplateAttribute(scriptTemplate, "template-name") || defaultName, base = getScriptTemplateAttribute(scriptTemplate, "template-base") || null;
            return createTemplate(trim(angular.element(scriptTemplate).html()), name, base);
        }
        function createTemplate(template, name, base) {
